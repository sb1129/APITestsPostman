...
newman.run({
    ...
    reporter : { 
	htmlextra : { export : './reports/html/CCM/Actions/AddAction_TestReport.html', logs: true, timezone: "Australia/Brisbane",
    browserTitle: "AI AddAction Test Report", title: "AI AddAction Test Dashboard", titleSize: 4}, 
	json: { export: './reports/json/CCM/Actions/AddAction_TestReport.json'}
	},
    insecure: true, 
    timeout: 1800000,
    delayRequest: 800
