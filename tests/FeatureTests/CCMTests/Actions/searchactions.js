...
newman.run({
    ...
    folder: ['SearchActions'],
    reporters: ['htmlextra','cli','json'],
    reporter : { 
	htmlextra : { export : './reports/html/CCM/Actions/SearchAction_TestReport.html', logs: true, timezone: "Australia/Brisbane",
    browserTitle: "AI SearchAction Test Report", title: "AI SearchAction Test Dashboard", titleSize: 4}, 
	json: { export: './reports/json/CCM/Actions/SearchAction_TestReport.json'}
	},
    insecure: true, 
    timeout: 1800000,
    delayRequest: 800
