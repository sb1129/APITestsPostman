...
newman.run({
    ...
    folder: ['AddTemplateRecord'],
    reporters: ['htmlextra','cli','json'],
    reporter : { 
	htmlextra : { export : './reports/html/VaultClientServiceApi/Database/AddTemplateRecord_TestReport.html', logs: true, timezone: "Australia/Brisbane",
    browserTitle: "AI AddTemplateRecord Test Report", title: "AI AddTemplateRecord Test Dashboard", titleSize: 4}, 
	json: { export: './reports/json/VaultClientServiceApi/Database/AddTemplateRecord.json'}
	},
    insecure: true, 
    timeout: 1800000,
    delayRequest: 800
