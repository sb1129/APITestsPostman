...
newman.run({
    ...
    folder: ['RetrieveTemplateRecord'],
    reporters: ['htmlextra','cli','json'],
    reporter : { 
	htmlextra : { export : './reports/html/VaultClientServiceApi/Database/RetrieveTemplateRecord_TestReport.html', logs: true, timezone: "Australia/Brisbane",
    browserTitle: "AI RetrieveTemplateRecord Test Report", title: "AI RetrieveTemplateRecord Test Dashboard", titleSize: 4}, 
	json: { export: './reports/json/VaultClientServiceApi/Database/RetrieveTemplateRecord.json'}
	},
    insecure: true, 
    timeout: 1800000,
    delayRequest: 800
