...
newman.run({
    ...
    folder: ['RetrieveGovernanceRecord'],
    reporters: ['htmlextra','cli','json'],
    reporter : { 
	htmlextra : { export : './reports/html/VaultClientServiceApi/Database/RetrieveGovernanceRecord_TestReport.html', logs: true, timezone: "Australia/Brisbane",
    browserTitle: "AI RetrieveGovernanceRecord Test Report", title: "AI RetrieveGovernanceRecord Test Dashboard", titleSize: 4}, 
	json: { export: './reports/json/VaultClientServiceApi/Database/RetrieveGovernanceRecord.json'}
	},
    insecure: true, 
    timeout: 1800000,
    delayRequest: 800
