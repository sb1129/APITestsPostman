...
newman.run({
    ...
    folder: ['UpdateTemplateRecord'],
    reporters: ['htmlextra','cli','json'],
    reporter : { 
	htmlextra : { export : './reports/html/VaultClientServiceApi/Database/UpdateTemplateRecord_TestReport.html', logs: true, timezone: "Australia/Brisbane",
    browserTitle: "AI UpdateTemplateRecord Test Report", title: "AI UpdateTemplateRecord Test Dashboard", titleSize: 4}, 
	json: { export: './reports/json/VaultClientServiceApi/Database/UpdateTemplateRecord.json'}
	},
    insecure: true, 
    timeout: 1800000,
    delayRequest: 800
