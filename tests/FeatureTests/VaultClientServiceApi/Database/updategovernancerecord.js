...
newman.run({
    ...
    folder: ['UpdateGovernanceRecord'],
    reporters: ['htmlextra','cli','json'],
    reporter : { 
	htmlextra : { export : './reports/html/VaultClientServiceApi/Database/UpdateGovernanceRecord_TestReport.html', logs: true, timezone: "Australia/Brisbane",
    browserTitle: "AI UpdateGovernanceRecord Test Report", title: "AI UpdateGovernanceRecord Test Dashboard", titleSize: 4}, 
	json: { export: './reports/json/VaultClientServiceApi/Database/UpdateGovernanceRecord.json'}
	},
    insecure: true, 
    timeout: 1800000,
    delayRequest: 800
